...
-- en la tabla triages se filtra con el numero de documento del paciente.
chequeo_triages 
-- y la tabla 
...
-- paciente 901 amarrado por triage
SELECT triage_pendiente_admitir_id, tipo_id_paciente, paciente_id, via_ingreso_id, comentario, departamento, empresa_id, centro_utilidad, plan_id, tipo_afiliado_id, semanas_cotizadas, autorizacion_int, autorizacion_ext, fecha_registro, usuario_id, causa_externa_id, estacion_id, evento, triage_id, paciente_urgencia_consultorio_id, rango
FROM public.triages_pendientes_admitir;
--buscamos por nuemero de paciente_id
